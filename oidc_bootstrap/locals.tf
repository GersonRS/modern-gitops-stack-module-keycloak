locals {
  ...
  oidc = {
    ...
    token_url     = format("https://keycloak.%s/realms/modern-gitops-stack/protocol/openid-connect/token", trimprefix("${var.subdomain}.${var.base_domain}", "."))
    api_url       = format("https://keycloak.%s/realms/modern-gitops-stack/protocol/openid-connect/userinfo", trimprefix("${var.subdomain}.${var.base_domain}", "."))
